...
SEMESTER_START = datetime.date(2025, 9, 8)
...
SCHEDULE = {
    0: {  # Понедельник
        "odd": [
            ("9:00 - 10:30",  "лек", "ВЫСШ. МАТЕМАТ",      "Шаповалов Е.В.",  "451"),
            ("10:50 - 12:20", "пр",  "ЭК ПО ФК И СПОРТУ",  "",                ""),
            ("12:40 - 14:10", "пр",  "ИН. ЯЗ.",             "Николаева О.В.",  "326* Я"),
        ],
        "even": [
            ("9:00 - 10:30",  "лек", "ВЫСШ. МАТЕМАТ",      "Шаповалов Е.В.",  "451"),
            ("10:50 - 12:20", "пр",  "ЭК ПО ФК И СПОРТУ",  "",                ""),
    ...
    1: {  # Вторник
        "odd": [
            ("10:50 - 12:20", "лаб", "ХИМИЯ",         "Барунин А.А., Маслобоев Д.С.", "558*, 560*"),
            ("12:40 - 14:10", "пр",  "ВЫСШ. МАТЕМАТ", "Сахаров В.Ю.",                 "488"),
        ],
        "even": [
            ("10:50 - 12:20", "лаб", "ХИМИЯ",         "Барунин А.А., Маслобоев Д.С.", "558*, 560*"),
            ("12:40 - 14:10", "пр",  "ВЫСШ. МАТЕМАТ", "Сахаров В.Ю.",                 "488"),
    ...
    2: {  # Среда
        "odd": [
            ("9:00 - 10:30",  "лек", "ИСТОРИЯ",           "Савинов М.А.",     "451"),
            ("10:50 - 12:20", "пр",  "ЭК ПО ФК И СПОРТУ", "",                 ""),
            ("12:40 - 14:10", "лек", "ИНФ.ТЕХН. И ПРОГР.", "Удовиченко А.С.",  "310"),
            ("14:55 - 16:35", "пр",  "ИСТОРИЯ",            "Охочинский Д.М.",  "488"),
        ],
        "even": [
            ("9:00 - 10:30",  "лек", "ИСТОРИЯ",           "Савинов М.А.",     "451"),
            ("10:50 - 12:20", "пр",  "ЭК ПО ФК И СПОРТУ", "",                 ""),
            ("12:40 - 14:10", "лек", "ИНФ.ТЕХН. И ПРОГР.", "Удовиченко А.С.",  "310"),
            ("14:55 - 16:35", "пр",  "ПРАВОВЕДЕНИЕ",       "Дмитриева А.П.",   "488"),
        ],
    },
    3: {  # Четверг
        "odd": [
            ("9:00 - 10:30",  "пр",  "ИНЖ.И КОМП. ГРАФ",    "Ракитская М.В., Ивкин С.П.", "505*"),
            ("10:50 - 12:20", "пр",  "ФИЗИКА",               "",                            "430*"),
            ("12:40 - 14:10", "лек", "ФИЗИКА",               "Комарова О.С.",               "327*"),
            ("14:55 - 16:35", "пр",  "ПСИХ-Я.ПРОФ.ДЕЯТ.",    "Алексеева Е.Н.",              "430*"),
        ],
        "even": [
            ("9:00 - 10:30",  "пр",  "ИНЖ.И КОМП. ГРАФ",    "Ракитская М.В., Ивкин С.П.", "505*"),
            ("10:50 - 12:20", "лаб", "ФИЗИКА",               "",                            "323*"),
            ("12:40 - 14:10", "лек", "ФИЗИКА",               "Комарова О.С.",               "327*"),
            ("14:55 - 16:35", "лек", "ХИМИЯ",                "Маслобоев Д.С.",              "331*"),
        ],
    },
    4: {  # Пятница
        "odd": [
            ("9:00 - 10:30",  "пр",  "ИНФ.ТЕХН. И ПРОГР.",   "Удовиченко А.С.", "ВЦ 280"),
            ("10:50 - 12:20", "лек", "ПРАВОВЕДЕНИЕ",          "Лебедь А.Л.",     "310"),
            ("12:40 - 14:10", "лек", "ПСИХ-Я.ПРОФ.ДЕЯТ.",     "Фомина А.П.",     "437*"),
        ],
        "even": [
            ("9:00 - 10:30",  "пр",  "ИНФ.ТЕХН. И ПРОГР.",   "Удовиченко А.С.", "ВЦ 280"),
        ],
